...
function TicketIcon() {
  return <svg width="22" height="22" viewBox="0 0 24 24" {...ic}><path d="M5 5h14a2 2 0 0 1 2 2v3a2 2 0 0 0 0 4v3a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-3a2 2 0 0 0 0-4V7a2 2 0 0 1 2-2Z" /><path d="M15 5v2M15 11v2M15 17v2" /></svg>;
}
function PhoneIcon() {
...
function WhatsappIcon() {
  // Official WhatsApp glyph, rendered monochrome via currentColor to match the
